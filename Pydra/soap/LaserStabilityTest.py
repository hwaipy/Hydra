from Services.MultiMeter.KeySight34465A import KeySight_MultiMeter_34465A, MeasureQuantity
...
if __name__ == '__main__':
    ...
    dev2.setMeasureQuantity(MeasureQuantity.VoltageDC, autoRange=False, range=0.3, aperture=1)
    ...
    while True:
        ...
        hbtFile.appendRow([currentTime * 1000, r1, r2])
        print([currentTime * 1000, r1, r2])