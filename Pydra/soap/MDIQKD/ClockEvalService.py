...
def init():
    ...
    # pll1_cfg16_fbdivrat_lsb[7:0] = 0xA
    dut.write(0x26, 0xA)
    ...
    # pll2_ro8_vtune_error_lsb[7:0] = 0x97
    dut.write(0x8D, 0x97)
    ...
    # clkgrp1_div1_cfg12_divrat_lsb[7:0] = 0xA
    dut.write(0xC9, 0xA)
    ...
    # clkgrp1_div2_cfg1_phdelta_mslip[1:1] = 0x1
    ...
    # clkgrp1_div2_cfg2_sel_outmux[1:0] = 0x1
    ...
    # clkgrp2_div1_cfg12_divrat_lsb[7:0] = 0x3
    dut.write(0xDD, 0x3)
    ...
    # clkgrp2_div1_cfg2_sel_outmux[1:0] = 0x1
    ...
    # clkgrp2_div2_cfg1_phdelta_mslip[1:1] = 0x1
    ...
    # clkgrp3_div1_cfg2_sel_outmux[1:0] = 0x1
    ...
    # clkgrp3_div2_cfg2_sel_outmux[1:0] = 0x1
    ...
    # clkgrp4_div1_cfg2_sel_outmux[1:0] = 0x1
    ...
    # clkgrp4_div2_cfg1_phdelta_mslip[1:1] = 0x1
    ...
    # clkgrp4_div2_cfg2_sel_outmux[1:0] = 0x1
    ...
    # clkgrp5_div1_cfg2_sel_outmux[1:0] = 0x1
    ...
    # clkgrp5_div2_cfg2_sel_outmux[1:0] = 0x1
    ...
    # clkgrp6_div2_cfg2_sel_outmux[1:0] = 0x1
    ...
    # clkgrp7_div1_cfg2_sel_outmux[1:0] = 0x1
    ...
    dut.write(0x152, 0x1B)


init()

pythonPath = 'C:\\Python37-32\\python'
pyScriptPath = 'C:\\Users\\Administrator\\Desktop\\Hydra\\Pydra\\Services\\Clock\\HMC7044Eval.py'
hydraServerAddr = '192.168.25.27'
hydraSererPort = 20102
clientName = 'HMC7044EvalTest'


def threadTarget():
    # cmd = '{} {} server={} port={} clientName={}'.format(pythonPath, pyScriptPath, hydraServerAddr, hydraSererPort, clientName)
    # print(cmd)
    ...
    while True:
        ...
        while True:
            ...
            if nP == -1: break
            cmd = cmdBuffer[:nP]
            cmdBuffer = cmdBuffer[nP + 1:]
            cmdSp = [int(c) for c in cmd.split(',')]
            dut.write(cmdSp[0], cmdSp[1])
...
# pydraPath = 'C:\\Users\\Administrator\\Desktop\\Hydra\\Pydra'
#
# import sys
# sys.path.append(pydraPath)
# sys.path.append('C:\\Python27\\Lib\\site-packages')
# sys.path.append('C:\\Python27\\Lib')
# from Pydra import Session
# Session.newSession((hydraServerAddr, hydraSererPort), None, 'Test')
# time.sleep(2)
# print('con')
